...
export default function ButtonWhatsApp() {
  ...
  const tooltip = "Chatea con nosotros ahora! 👋";
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] flex items-end">
      {showMessage && (
        <div className="mr-3 mb-2 bg-white rounded-xl shadow-lg p-2 pr-4 flex items-center animate-fadeIn">
      ...
      >
        <Link
          href={whatsappLink}
          target="_blank"
          className="w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-300"
        >
          {/* Icono WhatsApp */}
          <svg
