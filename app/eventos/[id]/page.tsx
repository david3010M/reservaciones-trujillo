...
import {getSalon, getSalones} from "@/components/salones/lib/salon.actions";
                ...
                <div className="grid grid-cols-2 gap-16">
                    ...
                    <div>
                        {salon.servicios.slice(0, 2).map((servicio, idx) => {
                            const Icon = LucideReact[servicio.icono] as React.ComponentType<any>;
                            return (
                ...
                <div className="flex justify-center flex-wrap gap-8">
                    {salon.paquetes.map((paquete, idx) => (
                        <div className="text-center" key={idx}>
                            ...
                            <p className="text-hotel-brown font-roboto text-lg mb-4">S/ {paquete.precio}</p>
